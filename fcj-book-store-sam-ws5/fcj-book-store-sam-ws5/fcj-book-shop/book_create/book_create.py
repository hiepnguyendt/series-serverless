...
def lambda_handler(event, context):
    bucket_image_shop = os.environ['BUCKET_SOURCE']
    bucket_image_resize_shop = os.environ['BUCKET_DES']
    ...
    if content_type == 'application/json':
        ...
        s3.put_object(Bucket=bucket_image_shop, Key=name, Body=image)
        image_path = "https://{}.s3.{}.amazonaws.com/{}".format(bucket_image_resize_shop, runtime_region, name)
